...
import admin # <<< Import admin module directly
from admin import (
    ...
    # <<< Product Type Reassign Handlers - ADDED HERE >>>
    handle_adm_reassign_type_start,
    handle_adm_reassign_old_type_name_message,
    handle_adm_reassign_new_type_name_message,
    handle_confirm_force_delete_prompt # <<< CHANGED from handle_confirm_force_delete_type
    # <<< END ADDED >>>
)
    ...
    async def wrapper(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query and query.data:
            ...
            KNOWN_HANDLERS = {
                ...
                "adm_manage_users": handle_manage_users_start, # This one is from viewer_admin
                "adm_view_user": handle_view_user_profile,    # This one is from viewer_admin
                "adm_adjust_balance_start": handle_adjust_balance_start, # This one is from viewer_admin
                "adm_toggle_ban": handle_toggle_ban_user,        # This one is from viewer_admin
                # -----------------------------------
                ...
                # -----------------------------------
                # <<< Product Type Reassign/Force Delete Callbacks - MODIFIED >>>
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    STATE_HANDLERS = {
        ...
        'awaiting_welcome_description_edit': admin.handle_adm_welcome_description_edit_message,
        'awaiting_welcome_confirmation': None, # Handled by callback (admin.handle_confirm_save_welcome)

        # User Management States (from viewer_admin)
        ...
        # <<< Product Type Reassign States - ADDED >>>
        'awaiting_reassign_old_type_name': admin.handle_adm_reassign_old_type_name_message,
        'awaiting_reassign_new_type_name': admin.handle_adm_reassign_new_type_name_message,
        # <<< END ADDED >>>
    }
...
def main() -> None:
    ...
    application.add_handler(CommandHandler("admin", handle_admin_menu)) # From admin module
