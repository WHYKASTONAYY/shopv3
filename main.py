...
from admin import (
    ...
    handle_confirm_force_delete_type # <<< ADDED: Force delete type confirmation
    # <<< END ADDED >>>
)
    ...
    async def wrapper(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if query and query.data:
            ...
            KNOWN_HANDLERS = {
                ...
                # -----------------------------------
                # <<< Product Type Reassign/Force Delete Callbacks - ADDED >>>
                "adm_reassign_type_start": handle_adm_reassign_type_start,
                "confirm_force_delete_type": handle_confirm_force_delete_type,
                # <<< END ADDED >>>
                # Stock Handler
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    STATE_HANDLERS = {
        ...
        'awaiting_reassign_old_type_name': handle_adm_reassign_old_type_name_message,
        'awaiting_reassign_new_type_name': handle_adm_reassign_new_type_name_message,
        # <<< END ADDED >>>
    }
